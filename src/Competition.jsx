...
const biImg       = '/BI.jpg'
const dcImg       = '/digital_creatory.jpg'
const scImg       = '/S_challenge.jpg'
const aiImg       = '/AI_in_Business.jpg'
const erpImg      = '/ERPSIM.jpg'
const attackerImg = '/Attacker.jpg'
const feseImg     = '/FESE.jpg'
const wapaImg     = '/WAPA.jpg'
const sysImg      = '/Sail_Your_Ship.jpg'
const MarHive     = '/MArHive.jpg'
const CMO         = '/CMO.jpg'
const FTUDA       = '/FTU_DA.jpg'
